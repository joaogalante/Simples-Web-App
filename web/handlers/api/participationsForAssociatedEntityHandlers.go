...
func GetParticipationsForAssociatedEntityResource(db *sql.DB, auth *auth.Model) resource.Model {
	// GET /entity/:entityID/participations-for-associated-entity
	index := func(w http.ResponseWriter, r *http.Request) {
		vars := mux.Vars(r)
		id, _ := strconv.Atoi(vars["entityID"])

		l, err := models.ListParticipationsForAssociatedEntity(db, id)
